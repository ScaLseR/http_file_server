...
class OneFileStorageTests(TestCase):
    ...
    def setUp(self) -> None:
        self.fch.upload_by_param(id='1', name='name1', tag='test', data='1_name1')
    ...
    def test_upload_full_param_and_wrong_param(self):
        ...
        self.assertCountEqual(self.fch.upload_by_param(id='1',
                                                       name='name2',
                                                       tag='test4',
    ...
    def test_get_without_param(self):
        """get without parameters"""
        self.assertCountEqual(self.fch.get_by_param(), REFERENCE_DICT)

    #7
    def test_get_wrong_param(self):
        """get with only wrong parameter"""
        self.assertCountEqual(self.fch.get_by_param(param='test7'), REFERENCE_DICT)
    ...
    def test_get_by_wrong_name(self):
        """get by wrong name"""
        self.assertEqual(self.fch.get_by_param(name='name'), {})

    #12
    def test_get_by_tag(self):
        """get by tag"""
        result = self.fch.get_by_param(tag='test')
        self.assertCountEqual(result, REFERENCE_DICT)
        self.assertEqual(result['id'], '1')
    ...
    def test_get_by_wrong_tag(self):
        """get by wrong tag"""
        self.assertEqual(self.fch.get_by_param(tag='tes'), {})

    #14
    def test_get_by_size(self):
        """get by size"""
        result = self.fch.get_by_param(size=7)
        self.assertCountEqual(result, REFERENCE_DICT)
        self.assertEqual(result['id'], '1')
    ...
    def test_get_by_mimetype(self):
        """get by mimetype"""
        result = self.fch.get_by_param(mimetype='text/plain')
        self.assertCountEqual(result, REFERENCE_DICT)
        self.assertEqual(result['id'], '1')
    ...
    def test_get_by_wrong_mimetype(self):
        ...
        self.assertEqual(self.fch.get_by_param(mimetype='text'), {})
    ...
    def test_delete_by_id(self):
        """delete by id"""
        self.assertEqual(self.fch.delete_by_param(id='1'), '1 files deleted')

    #25
    def test_delete_several_by_one_id(self):
        """several delete by one id"""
        self.assertEqual(self.fch.delete_by_param(id='1'), '1 files deleted')
        self.assertEqual(self.fch.delete_by_param(id='1'), '0 files deleted')

    #26
    def test_delete_by_wrong_id(self):
        """delete by wrong id"""
        self.assertEqual(self.fch.delete_by_param(id='2'), '0 files deleted')

    #25
    def test_delete_by_name(self):
        """delete by name"""
        self.assertEqual(self.fch.delete_by_param(name='name1'), '1 files deleted')

    #26
    def test_delete_by_wrong_name(self):
        """delete by wrong name"""
        self.assertEqual(self.fch.delete_by_param(name='name'), '0 files deleted')

    #27
    def test_delete_by_tag(self):
        """delete by tag"""
        self.assertEqual(self.fch.delete_by_param(tag='test'), '1 files deleted')

    #28
    def test_delete_by_wrong_tag(self):
        """delete by wrong tag"""
        self.assertEqual(self.fch.delete_by_param(tag='tes'), '0 files deleted')
    ...
    def test_download_by_id(self):
        """download by id"""
        self.assertEqual(self.fch.download_by_param(id='1'), '1_name1')
    ...
    def test_download_by_wrong_id(self):
        ...
        self.assertEqual(self.fch.download_by_param(id='2'), (404, 'файл не существует'))
    ...
    def test_download_by_id_check_content_type(self):
        ...
        result = self.fch.download_check_param(id='1')
