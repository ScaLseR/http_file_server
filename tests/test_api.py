...
class TestManyFilesStorage:
    ...
    def test_get_files_by_name_tag(self, upl_few, params):
        ...
        upl_few.upload_by_param(params(name='part_3_test_7', tag='test'), data='test7')
        upl_few.upload_by_param(params(name='part_3_test_7', tag='test'), data='test7')
        upl_few.upload_by_param(params(name='part_3_test_7', tag='test'), data='test7')
    ...
    def test_delete_name_tag(self, upl_few, params):
        ...
        upl_few.upload_by_param(params(name='part_3_test_11', tag='test'), data='test11')
        upl_few.upload_by_param(params(name='part_3_test_11', tag='test'), data='test11')
        upl_few.upload_by_param(params(name='part_3_test_11', tag='test'), data='test11')
        assert upl_few.delete_by_param(params(name='part_3_test_11', tag='test')) == '3 files deleted'
